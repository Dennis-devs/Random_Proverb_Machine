...
class MyProverbs extends React.Component{ 
  ...
  render(){
    return(
      ...
      <div id="quote-box" class="well col-md-6">
       <div class="upper"> 
        <p id="text" class="text-center">{this.state.message}</p>
        <footer id="author" class="text-center">{this.state.verse}</footer>
       </div>
         <div class="lower">   
          <div class="low1"><button onClick={this.handleClick.bind(this)} class="btn btn-info" id="new-quote">
            New Proverb
          </button> </div>
          <div class="low2"><a href="twitter.com/intent/tweet" target="_blank" id="tweet-quote"><i class="fa fa-twitter"></i></a>
          <a href="http://bible.com/en-GB/bible/116/PRO.1.NLT" target="_blank" id="bible" data-toggle="tooltip" title="More Proverbs" data-placement="right"><i class="fa fa-bible"></i></a>
...
ReactDOM.render(<MyProverbs />, document.getElementById("root"))